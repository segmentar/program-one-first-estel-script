...
namespace Core
{
    ...
    public partial class ControlFlowScheduleSimple
    {
        public unsafe ControlFlowScheduleSimple(String file, String renderFile)
        {
            ...
            using (fileStream = File.OpenRead(file))
            {
                ...
                fixed (Byte* pointer = byteArray)
                {
                    ...
                    controlFlowSchedule = ControlFlowSchedule.MakeControlFlowScheduleDefaultSurface(file, stringItem, renderFile);
