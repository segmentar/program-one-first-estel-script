            ...
            using (binaryWriter = new BinaryWriter(memoryStream))
            {
                ...
                section_HEADER:
                {
                    ...
                    foreach (String stringItem in array_HEADER)
                    {
                        ...
                        binaryWriter.Write(Convert.ToByte(stringItem.Length));

                        binaryWriter.Write(ArchitecturePageTwoSecond.StringCodec.GetBytes(stringItem));
                ...
                section_CONTENT:
                {
                    ...
                    binaryWriter.Write(Convert.ToByte(content.Length));

                    binaryWriter.Write(ArchitecturePageTwoSecond.StringCodec.GetBytes(content));
                }
